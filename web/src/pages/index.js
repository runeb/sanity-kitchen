...
const IndexPage = props => {
    ...
    .map(c => {
      switch (c._type) {
        ...
        case "image":
          ...
          return <Img fluid={fluidProps} alt={c.alt} />;
        default:
          return null;
      }
    });
  ...
  if (site.primaryColor && site.primaryColor.hex) {
    gradient.from = site.primaryColor.hex;
  }
  if (site.secondaryColor && site.secondaryColor.hex) {
    gradient.to = site.secondaryColor.hex;
  }
